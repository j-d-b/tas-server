...
const addAppt = isAuthenticatedResolver.createResolver(
  async (_, { details: { userEmail, timeSlot, type, ...typeSpecific } }, { user, AllowedAppts, Appt, Block, Config, User }) => {
    ...
    await isAvailableCheck([newAppt], AllowedAppts, Appt, Block, Config); // appt scheduling logic
